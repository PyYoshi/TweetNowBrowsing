...
function previewTemplate() {
    ...
    let compiled = template(templateTxt);
    ...
    chrome.storage.sync.get(
        ...
        (object) => {
            ...
            if (CHROME_STORAGE_KEY_NOTIFICATION_DISPLAY_TIME_SEC in object) {
                ...
                notificationDisplayTimeElement
                    .val(CHROME_STORAGE_KEY_NOTIFICATION_DISPLAY_TIME_SEC_DEFAULT_VALUE)
                    .change();
            }
        }
    );
